// Offline preview for the Teammates daily generator. Thin CLI over the runtime
// source of truth (lib/games/teammates/generate.ts) so what you see here is
// exactly what a given date will serve. Use it to eyeball upcoming puzzles for
// curation before they go live.
//
// Run: npx tsx scripts/generate-teammates-puzzle.ts [--start YYYY-MM-DD] [--n 7]
