...
export default async function AdsPage() {
  ...
  return (
    <>
      <PageHeader
        title="Explore"
        subtitle="Inventory catalog + render preview. Not live or sold — see Campaigns to book."
        breadcrumbs={[
      ...
      <p className="a-muted" style={{ marginBottom: 24 }}>
        Sample advertising inventory designed to live alongside the paper-mode
        digest. Four formats below, ordered least → most visually invasive. The
        preview at the bottom runs the <em>real</em> MLB renderer with ads
        spliced into the actual section anchors.
      </p>
