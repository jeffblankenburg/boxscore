...
import type { ClubhousePuzzle, PlayerCard, StatLine } from "@/lib/games/clubhouse/generate";
...
export function TeamStatCards({ puzzle, team }: { puzzle: ClubhousePuzzle; team: string }) {
